                ...
                <div class="zjsz">
                	<c:if test="${teachers!=null}">
				        <c:forEach items="${teachers}" var="t">
				        	<dl>
		                        <dd><img src="${t.t_pic}"/></dd>
		                        <dd class="teacher_text">
		                            <a href="">[${t.t_title}]${t.t_name}&nbsp;${t.t_job}</a>
		                            <p>${t.t_motto}</p>
		                            <p>技术方向：${t.t_skill}</p>
		                        </dd>
                   			</dl> 
...
<div id="RecruitTable" style="display: none">
    <div id="RecruitTable_div">
        <span id="close">X</span>
        <span class="RecruitTable_div_title">源辰科技招聘信息</span>
        <div class="RecruitTable_tb">
            <table rules="all" border="1">
                <tr class="tr_td">
                    ...
                    <th width="200">详细说明</th>
                    <th width="200">投递地址</th>
                    <th width="200">操作</th>
                </tr>
                <c:if test="${employList!=null}">
			        <c:forEach items="${employList}" var="em">
			        	<tr>
		                    <td>${em.e_position}</td>
		                    <td>${em.e_amount}</td>
		                    <td>${em.e_validtime}</td>
		                    <td>${em.e_salary}</td>
		                    <td>${em.e_detail}</td>
		                    <td>${em.e_addr}</td>
		                    <td><a style="color:blue;">投送简历</a></td>
                		</tr>
			        </c:forEach>
            	</c:if>
            </table>
