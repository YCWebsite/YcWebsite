...
<body>
	...
	<div class="kctx" style="height: 1500px; font-size: 100px;">
		<div class="kctx_title">衡阳源辰IT培训学校 > 就业详情</div>
		<div id="work">
			<h3>就业详情</h3>
			<div id="jobbox">
				<ul>
	...
	<div id="footer">
		<div class="address">
			<p>
				<span>${footWords.split(',')[0]}</span> <span>${footWords.split(',')[1]}</span>
				<span>${footWords.split(',')[2]}</span>
			</p>
			<p>
				<span>${footWords.split(',')[3]}</span> <span>${footWords.split(',')[4]}</span>
			</p>
		</div>
	</div>
</body>
