...
<meta name="Description"
	Content="公司是由多名资深项目经理共同组建而成，主要技术骨干在国内外从事多年软件项目研发工作，有在大型软件公司担任多年项目经理的经验；紧跟国内外先进的主流技术，具有较强的软件开发管理和技术指导能力。公司的发展目标是成为领先的软件开发服务商和IT软件工程师的供应商，我们致力于融合先进管理理念和信息技术，为企业和学员创造价值。我们的宗旨是服务于学生，致力于企业。">
<link rel="shortcut icon" href="images/logo.png">
<title>源辰信息科技官网</title>
<meta name="viewport"
	content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<link rel="stylesheet" media="screen and (min-width: 1024px)"
	href="css/newcomputer.css">
...
<body>
	<div id="header">
		...
		<ul id="nav">
			<li class="li1"><a href="index.action">${titles[0].d_type}</a></li>
			<h1 class="h1"></h1>
	...
	<div class="kctx">
		<div class="kctx_title">衡阳源辰IT培训学校 > 课程体系</div>
		<div id="course">
			<h3>课程体系</h3>
			<div id="course_content">
				<ul>
					<li class="j2ee course_current"><span>${courses[0].cs_name}</span>
					</li>
					<li class="html5"><span>${courses[1].cs_name}</span></li>
					<li class="ubuntu"><span>${courses[3].cs_name}</span></li>
					<li class="cloud"><span>${courses[2].cs_name}</span></li>
				</ul>
				<div id="course_img">
					<img src="images/loading.gif" data-original="${courses[0].cs_pic}"
						alt="${courses[0].cs_name}">
				</div>
			</div>
		</div>
	</div>
	...
	<script src="js/jquery.lazyload.js" type="text/javascript"></script>
	<script>
		$('#course_content ul li').mouseover(
				function() {
					var imgsrc = $(this).find('span').text();
					$(this).addClass('course_current').siblings().removeClass(
							'course_current');
