...
<div class="ftitle">公司历史</div>
	<div style="overflow: hidden;">
		<script id="history" name="history" type="text/plain" style="width:80%;height:250px;">
			${history}
		</script>
	</div>
	<form id="historyfm" method="post">
		<input type="hidden" value="公司历史" name="d_type"/>
...
<script type="text/javascript">
	var ue=UE.getEditor('history');//初始化对象
