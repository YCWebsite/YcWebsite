<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<table id="show_team" fit="true"></table>
<style>
#showUploadPic{
		display:none;
		margin-left:50px;
...
<div id="seeTeamPic"></div>
<div id="teamdlg" class="easyui-dialog"
	style="width:600px;height:400px;padding:35px 82px;" closed="true" buttons="#teamdlg-buttons">
	<form id="teamfm" method="post" enctype="multipart/form-data" novalidate>
		...
		<br/>
		<div class="fitem">
			<label>经  验：&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
...
<div id="teamdlg-buttons">
	...
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
		onclick="javascript:$('#teamdlg').dialog('close')" style="width:90px">取消</a>
</div>
...
<script type="text/javascript">
	...
	datagridObj=$('#show_team').datagrid({
		url:'show_team2.action',
		...
		columns:[[ 
	                ...
	                {field:'t_name',title:'姓名',width:30,align:'center'}, 
	                {field:'t_job',title:'职位',width:30,align:'center'},   
	                {field:'t_skill',title:'经验 ',width:250,align:'center'},
	                {field:'t_pic',title:'头像',width:30,height:50,align:'center',formatter:function(value,row,index){
	                	if(value!=null&& value!=""){
							return '<a href="javascript:seeTeamPic('+row.t_id+')">查看</a>';
						}else{
							return '无图片说明';
						}
	                }}
		...
		toolbar: [{
			...
			text:"添加",
			handler: function(){
				$('#teamdlg').dialog('open').dialog('setTitle','添加教师资料');
         		$('#teamfm').form('clear');
         		//图片预览
